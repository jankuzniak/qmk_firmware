...
// layer this one obscure game that has some odd controlls
[L_GAME_HW] = LAYOUT(
   KC_ESC,   KC_MS_BTN1, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                          XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
...
[L_NAVIGATION] = LAYOUT(
    ...
    KC_SYMB,    C(KC_Z),  C(KC_X),  C(KC_C),  C(KC_V),  KC_DITTO,    KC_MIC_MUTE,      _______,  XXXXXXX,     TG_NUMPAD,  C(KC_DOWN),  XXXXXXX,    C(KC_0),  C(KC_MINUS),
...
[L_NUMBERS] = LAYOUT(
    ...
    _______,  XXXXXXX,  KC_X,     XXXXXXX,  S(KC_SCLN),  XXXXXXX,  _______,      _______,  KC_EQL,   KC_PPLS,  KC_COMM,  KC_DOT,   KC_PSLS,  KC_PAST,
