...
[L_NUMBERS] = LAYOUT(
    ...
    _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  S(KC_SCLN),  XXXXXXX,      KC_EQL,   KC_PPLS,  KC_COMM,  KC_DOT,   KC_PSLS,  KC_PAST,
...
[L_SWITCH] = LAYOUT(
    ...
    _______,  KC_PSCR,        KC_SCRL,  G(KC_PAUS),  KC_NLCK,  XXXXXXX,         F_ZONE_1,  F_ZONE_2,  F_ZONE_3,  KC_APP,   XXXXXXX,  XXXXXXX,
